...
double Vehicle::update(double timestep, double distanceToControlPoint, double speedLimitMs)
{
  ...
  const double targetSpeed =
      std::min({maxOperatingSpeed, brakingSpeedLimit, std::max(0.0, speedLimitMs)});
