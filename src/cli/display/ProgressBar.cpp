...
namespace cli
{
    namespace display
    {
        ProgressBar::ProgressBar(int maxWidth, std::string rightText, std::string topText) : maxWidth(maxWidth), rightText(rightText), topText(topText) {}
        int ProgressBar::getMaxWidth() { return this->maxWidth; }
        int ProgressBar::getCurrentWidth() { return this->currentWidth; }
