...
bool network::PhysicalNode::hasCoordinate(
    const PhysicalCoordinate& nodeCoordinate) const {
    return this->initialized
        && this->coordinate.x == nodeCoordinate.x
        && this->coordinate.y == nodeCoordinate.y
        && this->coordinate.z == nodeCoordinate.z;
}