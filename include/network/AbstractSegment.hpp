...
namespace network
{
    ...
    public:
        ...
        AbstractSegment(AbstractNodeId start, AbstractNodeId end)
            : startNodeId(start), endNodeId(end) {}

        AbstractNodeId getStartNodeId() const { return startNodeId; }
        AbstractNodeId getEndNodeId() const { return endNodeId; }
